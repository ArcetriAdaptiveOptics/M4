...
class Noise():
    ...
    def rmsFromCube(self, cube_to_process):
        ...
        returns:
            rms_mean = rms averaged on the number of modes used in the iff's acquisition
            tip = tip averaged on the number of modes used in the iff's acquisition
            tilt = tilt averaged on the number of modes used in the iff's acquisition
        '''
    ...
    def different_template_analyzer(self, tt_list):
        ...
        return:
            rms_medio = vector of mean rms (one for each data folder)
            n_tempo = vector of the length of the templates used
        '''
    ...
    def analysis_whit_structure_function(self, tau_vector):
        ...
        returns:
            rms_medio = calculated on the difference of the images (distant tau)
