...
### test ###
    def _readMeasure(self):
        ...
        tt1 = '20200511_134609'
        tt2 = '20200511_134613'
        file_path1 = os.path.join(ShellActuatorFootprintRegistration._storageFolder(), tt1, 'act-marker.fits')
        file_path2 = os.path.join(ShellActuatorFootprintRegistration._storageFolder(), tt2, 'act-marker.fits')
