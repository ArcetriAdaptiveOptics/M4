...
from m4.configuration.root import folders as fold_name
...
class AnalyzerIFF:
    ...
    def createCubeFromImageFolder(
        ...
        list = osu.getFileList(fold=data_file_path)
    ...
    def _imageReader(self, filename: str):
        image = osu.read_phasemap(filename)
        return image
