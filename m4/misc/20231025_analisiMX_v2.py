...
if runa :
    ...
    path = '/mnt/disco1/Data/M4Data/OPTData/Alignment/'
...
for tn_curr in tnlist:
    print(tn_curr)
    coeffs=[]
    flist = glob.glob(path+tn_curr+fmask)
    ...
    if runa:
        qq=th.read_phasemap(fname)
        q = th.frame2ottFrame(qq,[580,20])
    else:
