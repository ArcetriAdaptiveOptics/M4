...
def view_calibration(imgott, imgpar,imgres, vm=50e-9, crpar=None):
    '''
    ...
    view_subplots(imgott, imgpar, imgres, crpar=None, vm=vm)
    view_subplots(imgott, imgpar, imgres, crpar,vm)

def view_subplots(imgott, imgpar, imgres, crpar=None, vm=50e-9):
